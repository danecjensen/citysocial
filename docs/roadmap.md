...
- notifications: durable follower activity inbox consuming feed.post_created and
  ...
  follow graph, direct feedback-status updates to submission authors, direct
  community-comment updates to post authors, unread badge, owner-only read controls,
  and public unread-count API.
