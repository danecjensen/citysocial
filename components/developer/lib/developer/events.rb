module Developer
  # All cross-module wiring for Developer lives here: what it listens
  ...
  module Events
    ...
    def subscribe!
      # Example:
      # PlatformCore::EventBus.subscribe("feed.post_created", method(:on_post_created))
    end

    # Events this module PUBLISHES (documented for discoverability):
    #   - "developer.something_happened"
  end
end
